<template>
  <div class="context-menu bg-white dark:bg-[#1d1e1f] rounded shadow-lg">
    <div class="py-1">
      <div class="menu-item" @click="handleAction('restore')">
        <el-button link type="primary" :icon="useRenderIcon(Share)"
          >恢复</el-button
        >
      </div>
